describe('#sortByAppearance', function() {
  it('Sort the characters in the first argument by the number of times each character appears in the text (descending)', function() {
    var characters = "$&*";
    var text = "Lo**remips&umdolo*sesdf*rsita$$met";
    expect(sortByAppearance(characters, text)).toEqual("*$&");
  });

  it('Sort the characters in the first argument by the number of times each character appears in the text (descending)', function() {
    var characters = "aeiouy";
    var text = "Loremipsumdolorsitamet,consecteturadipiscingelit.Nullamiaculisvehiculaquamegethendrerit.Sedconvallissodalesodioacursus.Doneccursusbibendumadipiscing.Etiammilibero,aliquamacauguesitamet,ornareplaceratneque.Quisquevariusconguemolestie.Suspendissescelerisquemetusvitaeimperdietvulputate.Morbiultricesullamcorperarcuaelementum.Duisvitaesapiennunc.Duiselementumnuncin";
    expect(sortByAppearance(characters, text)).toEqual("eiuaoy");
  });
  ...
  it('Sort the characters in the first argument by the number of times each character appears in the text (descending)', function() {
    ...
    expect(sortByAppearance(characters, text)).toEqual("binoculars_fmgdepthjkqvwxyz");
  });
